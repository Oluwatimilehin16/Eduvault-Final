...
<body>
   ...
   <section class="dashboard">
    <div class="box-container">
        ...
        <div class="box">
            <?php
            $select_orders  = mysqli_query($conn, "SELECT * FROM `order` WHERE payment_status='complete'")
            or die('query failed');
        ...
        <div class="box">
            <?php
            $select_products = mysqli_query($conn, "SELECT * FROM `order` WHERE payment_status='complete'")
            or die('query failed');
